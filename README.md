...
```
git clone https://github.com/yosriady/ark-minter
npm install
...
**ark-minter** © 2019+, Yos Riady. Released under the [MIT] License.<br>
...
[contributors]: http://github.com/yosriady/ark-minter/contributors
